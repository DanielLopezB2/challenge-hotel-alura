 ...
 * @author USUARIO
 */
public class EditarHuesped extends javax.swing.JFrame {
    ...
    public EditarHuesped(int numeroReserva) {
        initComponents();
        
        String numeroReservaStr = String.valueOf(numeroReserva);       
        
        miHuesped.consultaHuespedId(numeroReserva);
        Huesped huesped = miHuesped.consultaHuespedId(numeroReserva);
        
        String fechaNacimientoStr = huesped.getFechaNacimiento(); // Supongamos que esto es "2023-08-23"
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date fechaNacimiento = null;
        
        BigInteger telefonoBigInt = huesped.getTelefono();
        String telefonoStr = telefonoBigInt.toString();
        ...
        txtFechaNacimiento.setDate(fechaNacimiento);
        cbxNacionalidad.setSelectedItem(huesped.getNacionalidad());
        txtTelefono.setText(telefonoStr);
        txtNumeroReserva.setText(numeroReservaStr);
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (miHuesped.editarHuesped(objHuesped)) {

                JOptionPane.showMessageDialog(rootPane, "El huesped se ha actualizado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarHuesped.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarHuesped().setVisible(true);
            }
        });
    }
